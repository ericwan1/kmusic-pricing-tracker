...
while(not_an_empty_page and index < 251):
    pg_count_url = f"https://www.musicplaza.com/collections/cd?page={index}&view=ajax"
...
if lists_equal_len:
    ...
    output_df.to_csv('musicplaza_merch.csv',index=False)
else:
