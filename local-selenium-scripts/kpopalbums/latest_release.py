...
try:
    base_page_url = "https://www.kpopalbums.com/collections/lastest-release"
...
for page_ind in range(1, total_pages + 1):
    try:
        ...
        base_url = "https://www.kpopalbums.com/collections/lastest-release"
...
if lists_equal_len and len(product_name_list) > 0:
    ...
    output_file = 'kpopalbums_lastest_release.csv'
