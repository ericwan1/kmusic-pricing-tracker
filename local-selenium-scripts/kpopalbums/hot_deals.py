...
try:
    base_page_url = "https://www.kpopalbums.com/collections/hot-deals"
...
for page_ind in range(1, total_pages + 1):
    try:
        ...
        base_url = "https://www.kpopalbums.com/collections/hot-deals"
...
if lists_equal_len and len(product_name_list) > 0:
    ...
    output_file = 'kpopalbums_hot_deals.csv'
