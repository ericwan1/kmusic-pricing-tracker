...
def scrape_k_pop():
    ...
    while(not_an_empty_page and index < 160):
        page = requests.get("https://www.musicplaza.com/collections/k-pop?page={index}&view=ajax",headers=headers)
