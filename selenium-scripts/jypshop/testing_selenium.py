...
# so for stray kids albums it is the ones; with two surplus records for page numbers, and 4 per record at the end
# twice is similar, with two surplus records at the end for page numbers, and 4 per record at the end. 
# solution is to test all of the links in the same pattern; 
# we begin at index tatotal_items * 4
...
output_df.to_csv('test_jyp_shop_albums.csv')