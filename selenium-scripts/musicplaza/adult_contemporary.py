...
while(not_an_empty_page and index < 15):
    pg_count_url = f"https://www.musicplaza.com/collections/adult-contemporary?page={index}&view=ajax"
...
if lists_equal_len:
    ...
    output_df.to_csv('musicplaza_adult_contemporary.csv',index=False)
else:
